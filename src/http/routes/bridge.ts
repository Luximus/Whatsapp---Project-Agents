...
} from "../../application/bridge/sessionStore.js";
import { requireBridgeProjectAuth, requireDispatchToken } from "../../http/helpers/bridgeAuth.js";
...
export const bridgeRoutes: FastifyPluginAsync = async (fastify) => {
  ...
  fastify.post("/api/bridge/webhooks/verify", async (request) => {
    ...
    if (!result.found) {
      throw notFound("bridge_session_not_found");
    }
