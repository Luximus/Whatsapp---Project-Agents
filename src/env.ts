...
const envSchema = z.object({
  ...
  WHATSAPP_AUDIO_VOICE_NOTE_PROBABILITY: z.coerce.number().min(0).max(100).default(100),
  WHATSAPP_AUDIO_INCLUDE_TEXT_PROBABILITY: z.coerce.number().min(0).max(100).default(100),
...
export const env = {
  ...
  whatsappAudioVoiceNoteProbability: raw.WHATSAPP_AUDIO_VOICE_NOTE_PROBABILITY,
  whatsappAudioIncludeTextProbability: raw.WHATSAPP_AUDIO_INCLUDE_TEXT_PROBABILITY,
